...
Unha vez creada a sentenza preparada debemos sustituir os  interrogantes da sua sentenza por valores concretos para o cal usamos os metodos adecuados da sentenza preparada en funcion do tipo de dato .
Por exemplo , se o primeiro interrogante da sentenza anterior esta sustituindo a un campo de tipo varchar2, o metodo a usar sera setString(int i, String p), onde a tetra "i" e a posicion que ocupa o interrogante na sentenza preparada e a letra "p" o valor que se vai ssutituir en lugar de dito interrogante. Concretamdo mais , se o a sentenza preparada se chama ps e o valor que quero sustituir e "froitas_neves " , a preparacion da sentenza para este valor será así:
...
nota:
os metodos das sentenzas preparadas  para executar consultas e desenvolver operacions de actualizacion (insercion, modificacion e borrado)
